...
export default function Gallery() {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      {!showEmptyState && (
        <section className="w-full bg-surface-bright border-b border-surface-container-high sticky top-20 z-30 backdrop-blur-md bg-surface/95">
          <div className="max-w-[1320px] mx-auto px-margin-mobile md:px-margin-tablet lg:px-margin-desktop py-space-sm">
            <CountyFilterPills
              counties={counties}
          ...
          {showEmptyState ? (
            ...
            <div className="flex flex-col items-center text-center gap-space-xs py-space-2xl bg-surface-container-low rounded-xl">
              ...
              <p className="font-body-md text-body-md text-on-surface-variant">
                No published photos from {selectedCounty} right now.
              </p>
            </div>
          ) : (
